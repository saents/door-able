...
function next(){
	...
	if(CURRENT_LEVEL<LEVEL_CONFIG.length){
		...
		var extraTime = 6600 - totalRewindTime*2000;
		if(extraTime<0){
...
function iHeartYou(){
	...
	document.getElementById("screen_two").style.background = "#252525";
	...
	if(window.location.hash){
		...
		vtext.textContent = "ԵՍ ՔԵԶ ՇԱՏ ԵՄ ՍԻՐՈՒՄ ԿՅԱՆՔՍ (◕‿◕)♡";
